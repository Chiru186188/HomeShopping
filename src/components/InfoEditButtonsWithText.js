...
const InfoEditButtonsWithText = ({ onEditPress,Oninfopress, text,text1 }) => {
  return (
...
<TouchableOpacity onPress={Oninfopress} style={styles.addButton}>
...
InfoEditButtonsWithText.propTypes = {
...
export default InfoEditButtonsWithText;
